...
-   **Office Hours and Availability:** Please make an appointment to speak one-on-one using my [Calendly page](%7B%7B%3C%20var%20instructor.calendly_url%20%3E%7D%7D). Of course, I'm also happy to chat either before or after our class if i'm available.
...
UP 570: Neighborhood Analysis is open to students with graduate-level standing. The course assumes that you have previously taken [UP 517: Data Science for Planners](https://courses.illinois.edu/schedule/terms/UP/517) or have substantial experience with manipulating data in R.
