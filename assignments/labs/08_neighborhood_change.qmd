...
![](08_neighborhood_change/images/03_NVC_Three_Cities.png) Start by counting how many tracts there are in each city and how many people lived in each city in 2019. Use `group_by()` and `summarise()` to accomplish this.
